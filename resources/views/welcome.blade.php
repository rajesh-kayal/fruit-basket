                                        ...
                                        <div class="rounded position-relative fruite-item">
                                            <div class="fruite-img">
                                                @if (!empty($product->images))
                                                    <img src="{{ asset(explode(',', $product->images)[0]) }}" class="img-fluid w-100 rounded-top" alt="Product Image">
                                                @else
        ...
        <script src="{{asset('js/quantity.js')}}"></script>
                ...
                <script>
                    function addProductToCart(productId) {
                        const form = document.querySelector(`form.product-form input[name="product_id"][value="${productId}"]`).closest('form');
                        form.submit();
                    }
                </script>

@include('extra_product')
